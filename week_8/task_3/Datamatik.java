...
public class Datamatik {
    public static void main(String[] args)  {
        Teacher teacher0 = new Teacher("Jesper", 87, false);
        Student student0 = new Student("Frederik", 23, false, 1);
        Student student1 = new Student("Christian", 19, false, 1);

        System.out.println(teacher0.name + ", " + teacher0.age + ", is female: " + teacher0.isFemale);

        System.out.println(student0.name + ", " + student0.age + ", is female: " + student0.isFemale + ", Team: " + student0.datamatikerTeam);
        System.out.println(student1.name + ", " + student1.age + ", is female: " + student1.isFemale + ", Team: " + student1.datamatikerTeam);
    }
}
